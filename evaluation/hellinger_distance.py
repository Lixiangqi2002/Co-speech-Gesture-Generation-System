...
def main():
    ...
    parser.add_argument('--original', default='resulting_hmd_csv/UGT',
                        help='Original gesture directory')
    parser.add_argument('--predicted', '-p', default='resulting_hmd_csv/',
                        help='Predicted gesture directory')
    parser.add_argument('--file', '-f', default='hmd_acc_0.05.csv',
                        help='File name to load')
    parser.add_argument('--select', '-s', nargs='+',
                        help='Joint subset to compute (if omitted, use all)')
    parser.add_argument('--visualize', '-v', action='store_true',
                        help='Visualize histograms')
    parser.add_argument('--out', '-o', default='results_hellinger_acc_distance',
