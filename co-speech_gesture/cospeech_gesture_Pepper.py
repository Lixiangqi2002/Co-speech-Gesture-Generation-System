...
#     'HeadPitch': 'b_head.Yrotation',
#
#     # 'HipRoll': 'b_root.Xrotation',  # not sure
#     # 'HipPitch': 'b_root.Yrotation',  # not sure
#
#     'LShoulderPitch': 'b_l_shoulder.Yrotation',  # Y
#     'LShoulderRoll': 'b_l_shoulder.Zrotation',  # Z
#     'LElbowYaw': 'b_l_arm.Xrotation',
#     'LElbowRoll': 'b_l_arm.Zrotation',
#     # 'LElbowPitch' : 'b_l_arm.Yrotation',
#
#     'RShoulderPitch': 'b_r_shoulder.Yrotation',
#     'RShoulderRoll': 'b_r_shoulder.Zrotation',
#     'RElbowYaw': 'b_r_arm.Xrotation',
#     'RElbowRoll': 'b_r_arm.Zrotation',
#     # 'RElbowPitch': 'b_r_arm.Yrotation',
# }
...
class BVHLoader:
    ...
    def toPepperJoint(self, fetch_every=1):
        gesture_list = []
...
if __name__ == "__main__":
    ...
    tts.setParameter("speed", 60)  # Pepper
    tts.say("Hello, world! I am PEPPER!")
    ...
    synchronization_delay = 0  # 0  30  60  90  120  150 / 0, 1s, 2s, 3s, 4s, 5s
    ...
    for i in range(-synchronization_delay, times, 1):
        ...
        if i >= 0:  # 002
            for column in columns:
                value_write = 0
                """
                PEPPER without time sleep
                """
                if column == "HeadPitch" or column == "HeadYaw":
                    # if i % 5 == 0:
                    cur_val = (df[column][i] * almath.TO_DEG + 0) * 0.8
                    # print cur_val
                    motionProxy.post.setAngles(column, cur_val * almath.TO_RAD, 0.015)
                elif column == "LShoulderPitch" or column == "RShoulderPitch":
